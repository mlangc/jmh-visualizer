...
// biome-ignore lint/correctness/noUnusedVariables: read as a global by store.ts/DefaultTopBar.tsx, set via the <script> tag in index.html
  ...
  result: [
    {
      ...
      primaryMetric: {
        ...
        scoreConfidence: [3369067.897461809, 3566194.5626392737],
        scorePercentiles: {
        ...
        scoreUnit: 'ops/s',
        rawData: [
          [3524193.1540743182, 3531314.663170731, 3532453.3325443356, 3520395.64538141, 3474431.2865468427],
          [3440045.3067861893, 3333994.173460993, 3445535.4557112623, 3475555.716890452, 3398393.5659388755]
        ]
      },
      secondaryMetrics: {}
    }
