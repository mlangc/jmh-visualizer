  ...
  return (
    <Card.Footer style={{ marginTop: '20px', marginBottom: '0px', paddingLeft: '20px', fontSize: '0.90em' }}>
      <Container fluid={true}>
        <Row>
          <Col md={10}>
            <a href="https://mlangc.github.io/jmh-visualizer/" target="_blank" rel="noopener noreferrer">
              JMH Visualizer {process.env.version}
            </a>
          </Col>
          <Col md={2}>
            <a href="https://github.com/mlangc/jmh-visualizer" target="_blank" rel="noopener noreferrer">
              <GithubIcon size="1.5em" />
            </a>
            {' | '}
            <a href="https://github.com/mlangc/jmh-visualizer/issues" target="_blank" rel="noopener noreferrer">
              <BugIcon size="1.5em" />
            </a>
          </Col>
        </Row>
