...
describe('functions: cartesianProduct', () => {
  it('default', () => {
    ...
    expect(cartesianProduct([['a1', 'a2'], ['b'], ['c']])).to.deep.equal([
      ['a1', 'b', 'c'],
      ['a2', 'b', 'c']
    ]);
    expect(cartesianProduct([['a1', 'a2'], ['b1', 'b2'], ['c']])).to.deep.equal([
      ['a1', 'b1', 'c'],
      ['a1', 'b2', 'c'],
      ['a2', 'b1', 'c'],
      ['a2', 'b2', 'c']
...
describe('functions: getUniqueNames', () => {
  it('default', () => {
    ...
    expect(
      getUniqueNames([
        'https://gist.githubusercontent.com/jzillmann/7d23b2382911cc434754a23773b06598/raw/1bcad4bb64624d8a2be15114a4eee4c406c3ae95/string-concatenation_jdk7.json'
      ])
    ...
    expect(
      getUniqueNames([
        'https://gist.githubusercontent.com/xxx/aaa/jmh1.json',
        'https://gist.githubusercontent.com/xxx/aaa/jmh2.json'
      ])
    ).to.deep.equal(['1', '2']);
  });
});
